...
module.exports = {
  ...
  body: (p) => {
    ...
    const hotswap_front = `
            ...
            (pad 2 smd rect (at ${
              8.275 - (2.6 - p.outer_pad_width_back) / 2
            } -3.75 ${p.rot}) (size ${
      p.outer_pad_width_back
    } 2.6) (layers B.Cu B.Paste B.Mask) ${p.to.str})
    ...
    const hotswap_back = `
            ...
            ${"" /* Right Pad (cut off) */}
            (pad 1 connect custom (at 3.275 -5.95 ${
              p.rot
            ...
            (pad 2 smd rect (at ${
              -8.275 + (2.6 - p.outer_pad_width_front) / 2
            } -3.75 ${p.rot}) (size ${
      p.outer_pad_width_front
    } 2.6) (layers F.Cu F.Paste F.Mask) ${p.to.str})
